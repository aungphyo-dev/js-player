...
const Page = () => {
    return (
        <div className='prose-quoteless prose prose-gray prose-invert'>
            <div className="flex justify-between items-center w-full">
                <Image alt={"javascript"} height={"100"} width={"100"} src="/javascript.png"/>
            ...
            <p>
                ...
                <a href="https://www.instagram.com/theavocoder">Instagram</a> <a
                href="https://www.twitter.com/lydiahallie">Twitter</a> <a
                href="https://www.linkedin.com/in/lydia-hallie">LinkedIn</a> <a
                href="https://www.lydiahallie.io/">Blog</a>
